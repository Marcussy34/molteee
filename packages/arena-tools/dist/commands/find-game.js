 ...
 */
export async function findGameCommand(matchId) {
    ...
    if (!gameType) {
        ...
        fail(`No game created yet for match ${matchId}. The challenger needs to create the game first.`, "NO_GAME_YET");
        return;
    }
    ...
    // No game found
    fail(`No game found for match ${matchId}. The challenger may not have created the game yet. Try again in a few seconds.`, "GAME_NOT_FOUND");
}
//# sourceMappingURL=find-game.js.map