...
export const WS_RPC_URL =
  process.env.MONAD_WS_RPC_URL || "wss://testnet-rpc.monad.xyz";
...
export const GAME_TYPES = { rps: 0, poker: 1, auction: 2 } as const;
export type GameTypeName = keyof typeof GAME_TYPES;

// ─── Game contract mapping ──────────────────────────────────────────────────
export const GAME_CONTRACTS: Record<GameTypeName, string> = {
